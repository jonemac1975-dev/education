...
const TYPE = "theloai";        // loại danh mục
let currentId = null;

export function rendertheloai() {

  const main = document.getElementById("main");

  main.innerHTML = `
    <h2>Thể loại Sách - Tài liệu</h2>

    <input id="txtName" placeholder="Thể loại" style="padding:6px;width:300px">
